...
if (isset($_POST["update"])) {
    ...
    if ($result1 && $result2) { 
        ?>
        <h1 class="text-green-400 px-10 rounded">SUCCESS</h1>
        <?php
     }else{
        ?>
        <h1 class="text-rose-700 px-10 rounded">FAIL</h1>
        <?php
     }
}
?>
<h3 class="text-2xl font-bold px-10 text-black">TAMBAH MAKLUMAT PELAJAR</h3>
    <div class="px-10 text-left shadow-lg rounded-lg">
        <form method="post" enctype='multipart/form-data'>
            <div class="mt-4">
            <div class="mt-4">
                <label class="block text-black">NO NDP</label>
                ...
                <div class="mt-4">
                <label class="block text-black">NAMA PELAJAR</label>
                ...
                <div class="mt-4">
                <label class="block text-black">NO KP</label>
                ...
                <div class="mt-4">
                <label class="block text-black">JANTINA</label>
                ...
                <div class="mt-4">
                <label class="block text-black">NO HP</label>
                ...
                <div class="mt-4">
                <label class="block text-black">EMEL</label>
                ...
                <div class="flex pb-5 items-baseline justify-between">
                    ...
                    <button type="reset"><a class="text-sm text-blue-400 hover:underline">CLEAR</a></button>
                </div>
            </div>
        </form>
    </div>
