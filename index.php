...
<h3 class="text-2xl font-bold px-10 text-black">DDATA MAKLUMAT PELAJAR</h3>
        ...
        <table class="min-w-full text-center">
          ...
          <tbody>
            ...
            while ($info = mysqli_fetch_array($data1)) { ?>
              ...
              <td class="text-base black font-medium px-6 py-4 whitespace-nowrap">
                <?php echo $info["id"];?>
              </td>
              <td class="text-base textblack font-medium px-6 py-4 whitespace-nowrap">
                <?php echo $info["no_ndp"]; $ndp = $info["no_ndp"]?>
              </td>
              <td class="text-base textblack font-medium px-6 py-4 whitespace-normal">
